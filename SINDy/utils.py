...
def print_equations_cmmp(equations_clean, equations_noisy):
    print(f"{'':<30} {'Noiseless':<40} {'Noisy':<40}")
...
def print_equations(equations_clean):
    
    for k, (eq1) in enumerate(equations_clean):
        print(f"{'':<30} {'x' + str(k) + '=' + str(eq1):<40}")
